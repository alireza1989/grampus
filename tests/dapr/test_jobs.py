...
from nexus.core.errors import DaprJobsError, NexusError
...
async def test_schedule_job_calls_correct_endpoint() -> None:
    ...
    with patch("nexus.dapr.jobs.httpx.AsyncClient", return_value=cm):
...
def test_dapr_jobs_error_is_nexus_error() -> None:
