"""Template manifest model — loaded from grampus-template.yaml."""
...
class TemplateManifest(BaseModel):
    """Full manifest for a Grampus agent template."""
    ...
    def from_yaml(cls, path: Path) -> TemplateManifest:
        """Load manifest from grampus-template.yaml using yaml.safe_load()."""
