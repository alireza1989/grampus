...
from grampus.observability.alerts import AlertEvent, AlertSeverity

_log = structlog.get_logger("grampus.alerts")
...
class WebhookChannel:
    ...
    Args:
        ...
        secret: Optional shared secret. When set, adds X-Grampus-Signature header.
    ...
    async def send(self, event: AlertEvent) -> None:
        ...
        if self._secret:
            ...
            headers["X-Grampus-Signature"] = sig
        try:
...
class SmtpChannel:
    ...
    def __init__(
        ...
        from_addr: str = "grampus@localhost",
...
class LogChannel:
    ...
    Args:
        logger: Optional pre-built logger (defaults to grampus.alerts).
    """
