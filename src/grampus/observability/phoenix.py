...
def configure_phoenix_tracer(
    ...
    *,
    service_name: str = "grampus-agent",
    agent_id: str = "unknown",
    session_id: str | None = None,
) -> GrampusTracer:
    """Return a GrampusTracer pre-configured to export to Phoenix via OTLP.

    When config.enabled is False, returns a NoOp GrampusTracer (no OTLP export).
    ...
    Returns:
        A configured GrampusTracer instance.
    """
...
def phoenix_tracer(
    ...
    **kwargs: Any,
) -> Generator[GrampusTracer, None, None]:
    """Context manager that yields a Phoenix-connected GrampusTracer.
    ...
    Yields:
        A GrampusTracer configured to export to Phoenix.
    """
