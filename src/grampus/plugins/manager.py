...
class PluginManager:
    ...
    Args:
        plugins: Initial list of GrampusPlugin instances. Additional plugins can
                 be added later via .register().
    """

    def __init__(self, plugins: list[GrampusPlugin] | None = None) -> None:
        self._plugins: list[GrampusPlugin] = list(plugins or [])

    # ------------------------------------------------------------------
    # Registration
    # ------------------------------------------------------------------

    def register(self, plugin: GrampusPlugin) -> None:
    ...
    def _sorted_plugins(self) -> list[GrampusPlugin]:
    ...
    def _active(self) -> list[GrampusPlugin]:
