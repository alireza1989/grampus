"""grampus redteam — run an adversarial red-team campaign against an agent."""
...
from grampus.cli.commands._utils import load_module
...
def redteam_command(
    ...
    \b
    Example:
        grampus redteam my_agent.py --categories prompt_injection jailbreak --count 10
    """
...
async def _run(
    ...
    from grampus.evaluation.red_team.attacker import AttackerAgent  # noqa: PLC0415
    from grampus.evaluation.red_team.judge import RedTeamJudge  # noqa: PLC0415
    from grampus.evaluation.red_team.report import RedTeamReport  # noqa: PLC0415
    from grampus.evaluation.red_team.runner import RedTeamRunner  # noqa: PLC0415
    from grampus.evaluation.red_team.types import (  # noqa: PLC0415
        AttackCategory,
    ...
    if model_id:
        try:
            from grampus.cli.playground.model_factory import make_client  # noqa: PLC0415
            from grampus.core.config import GrampusConfig  # noqa: PLC0415

            model_client = make_client(model_id, GrampusConfig())
        except Exception:
            click.echo(
