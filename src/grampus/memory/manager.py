...
from grampus.memory.types import EpisodicRecord, Procedure, RetrievedRecord, SemanticFact
...
class MemoryManager:
    ...
    async def remember(
        ...
        **kwargs: Any,
        ...
        _mem_ctx: Any = None
        if self._plugins:
            from grampus.plugins.types import HookBlockedError, MemoryWriteContext
