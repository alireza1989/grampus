...
from grampus.memory.lifecycle.types import MemoryType, QueryClassification
...
class AdaptiveRetriever:
    ...
    async def retrieve(
        ...
        *,
        ...
        """
        from grampus.memory.manager import MemoryRecallResult  # noqa: PLC0415
    ...
    async def _retrieve_flat(self, query: str, top_k: int) -> MemoryRecallResult:
        ...
        from grampus.memory.manager import MemoryRecallResult  # noqa: PLC0415
        from grampus.memory.types import RetrievedRecord  # noqa: PLC0415

        episodic: list[RetrievedRecord] = []
        with contextlib.suppress(Exception):
            episodic = await self._ep_retriever.retrieve(query, top_k=top_k)

        from grampus.memory.types import SemanticFact  # noqa: PLC0415
    ...
    async def _retrieve_sequential(self, agent_id: str, top_k: int) -> MemoryRecallResult:
        ...
        from grampus.memory.manager import MemoryRecallResult  # noqa: PLC0415
        from grampus.memory.types import EpisodicRecord, RetrievedRecord  # noqa: PLC0415
