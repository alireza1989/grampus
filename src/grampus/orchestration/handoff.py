...
from grampus.core.errors import HandoffError, OrchestrationError
...
if TYPE_CHECKING:
    ...
    from grampus.orchestration.a2a.registry import AgentEntry
...
class HandoffExecutor:
    ...
    - The A2A ``AgentRegistry`` from ``grampus.orchestration.a2a.registry`` which
    ...
    async def execute(self, request: HandoffRequest) -> HandoffResult:
        ...
        try:
            ...
            if isinstance(raw_entry, tuple):
                ...
                #     Use this for Grampus-to-Nexus multi-service deployments.
                #
