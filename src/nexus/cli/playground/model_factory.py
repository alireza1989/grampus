...
def make_client(model: str, config: NexusConfig) -> ModelClient:
        ...
        if not key:
            raise ModelError(
                ...
                hint=(
                    ...
                    "under model.anthropic_api_key in nexus.yaml."
                ),
            )
        ...
        if not key:
            raise ModelError(
                ...
                hint=(
                    ...
                    "under model.openai_api_key in nexus.yaml."
                ),
            )
        ...
        if not key:
            raise ModelError(
                ...
                hint=(
                    ...
                    "under model.gemini_api_key in nexus.yaml."
                ),
            )
