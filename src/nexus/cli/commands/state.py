"""nexus state — export and restore agent state snapshots."""
...
from nexus.core.errors import ConfigError, SnapshotError
from nexus.orchestration.snapshot import SnapshotManager, StateSnapshot
...
@click.option("--config", default="nexus.yaml", help="Path to nexus.yaml.")
def export_cmd(
    agent_id: str,
    session_id: str,
    output: str | None,
...
def _print_snapshot_summary(
    ...
    *,
    ...
    rows = [
        ...
        ("Nexus version:", snap.nexus_version),
